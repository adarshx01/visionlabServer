...
export const TypingBox = () => {
  ...
  return (
    <div className="z-10 max-w-[600px] flex space-y-6 ml-[86rem] flex-col bg-gradient-to-tr from-slate-300/30 via-gray-400/30 to-slate-600-400/30 p-4 backdrop-blur-md rounded-xl border-slate-100/30 border">
      <div>
